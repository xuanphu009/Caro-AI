...
from source.model import CaroNet, build_preset, save_checkpoint, EMA
from source.dataset import CaroDataset
...
class WeightedMSELoss(nn.Module):
    """
    Weighted MSE to handle label imbalance
...
class Trainer:
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Model
        if model is None:
            print(f"🏗️  Building large model...")
            self.model = build_preset("large")
        else:
            self.model = model
