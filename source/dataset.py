...
class CaroDataset(Dataset):
    ...
    """
    def __init__(self, data_dir="data/professional", min_game_length=20, use_augmentation=False):
        self.boards = []
        self.results = []
        self.move_indices = []
    ...
    def _load_data(self, data_dir):
        ...
        for fname in sorted(os.listdir(data_dir)):
            ...
            # ✅ Nếu không có first_player, dùng heuristic (player 1 đi trước)
            if first_player is None:
                first_player = 1
                skipped_no_first_player += 1
            ...
            player = first_player  # Start with correct player
