...
class GameUI(object):
    ...
    def resetUI(self):
        ...
        self.screen.blit(self.board, (0,0))
        pygame.display.update()
        print("✓ UI reset - Ready for new game!")
    
    def drawAIModeMenu(self):
        """Draw menu for selecting AI mode"""
        menu_board = pygame.transform.scale(self.menuBoard, (400, 150))
        menu_board_rect = menu_board.get_rect(center=self.screen.get_rect().center)
        ...
        menu_board.blit(title_text, (200 - title_size[0]//2, 20))
        ...
        menu_board.blit(subtitle_text, (200 - subtitle_size[0]//2, 50))
